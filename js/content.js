...
const CONTENT = {
  ...
  // Amazonではどんな絵本がある？
  // ------------------------------------------------------------
  // 2026-08-08 Amazon実例のスクリーンショットで確認済み: イラストをAI(Midjourney)で
  // 制作したと明記した絵本が、レビュー63件・評価4.2で販売されている。価格は未確認のため未掲載。
  // 数値を更新する場合はこのparagraphs内の文章だけを差し替えればOK（他の箇所の修正は不要）。
  amazonExamples: {
    heading: "Amazonではどんな絵本がある？",
    paragraphs: [
      "Amazonでは、AIを活用した制作事例も見られるようになっています。",
      "実際に、イラストを画像生成AIで制作したと明記して出版し、63件のレビュー（評価4.2）が付いている作品もあります。",
...
の順番で出力してください。`,
  ...
  completedExample: {
    ...
    book: {
      title: "おかあさん だいすき",
      cover: { src: "assets/images/book/cover.jpg", alt: "絵本「おかあさん だいすき」の表紙" },
      pages: [
        { label: "1ページ目", src: "assets/images/book/page1.jpg", alt: "「おかあさん、おはよう。」きょうもいちばんに、おかあさんのおかおをみつけたよ。" },
        { label: "2ページ目", src: "assets/images/book/page2.jpg", alt: "おかあさんとあるくと、とってもたのしい。てくてく、てくてく。どこまでいこうかな？" },
        { label: "3ページ目", src: "assets/images/book/page3.jpg", alt: "「あっ！みつけた！」まっかなきのみ。おかあさんに、あげたいな。「はい、どうぞ！」" },
        { label: "4ページ目", src: "assets/images/book/page4.jpg", alt: "ひらひらちょうちょ。「まって、まって〜！」" },
        { label: "5ページ目", src: "assets/images/book/page5.jpg", alt: "あれ？おかあさんがいない。「おかあさーん！」しーん……。なんだかこころがきゅうっとなった。" },
      ],
    },
